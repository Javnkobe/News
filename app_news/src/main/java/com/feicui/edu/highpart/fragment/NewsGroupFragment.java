            ...
            public void run() {
                ...
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String url = Const.URL_NEWS_LIST+"ver=1&subid="+subids.get(0) +"&dir=1&nid=1&stamp=20140321&cnt=20";
                        ...
                        tab.addOnTabSelectedListener(new TabLayout.ViewPagerOnTabSelectedListener(vp){
                            ...
                            public void onTabSelected(TabLayout.Tab tab) {
                                ...
                                map.put("cnt","20");
                                String url = UrlParameterUtil.parameter(Const.URL_NEWS_LIST,map);
                                Log.d(TAG, url);
                                fragment.myAsyncLoad(url);
                            }
                        });
